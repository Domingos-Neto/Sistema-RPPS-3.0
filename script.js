...
function gerarAtoDePensao(b) {
    ...
    /* Ajuste o preenchimento (padding) conforme necessário */
    padding-top: 2.5cm;
    padding-bottom: 2cm;
}</style>`,
